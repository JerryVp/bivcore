...
function builder(options) {
  ...
  if (!options.network) {
    options.network = bivcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || bivcore.Block;
  options.BlockHeader = options.BlockHeader || bivcore.BlockHeader;
  options.Transaction = options.Transaction || bivcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || bivcore.MerkleBlock;
