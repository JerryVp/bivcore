...
- [Peer to Peer Networking](https://github.com/bitpay/bivcore/tree/master/packages/bivcore-p2p)
- [Bitcoin Core JSON-RPC](https://github.com/bitpay/bitcoind-rpc)
- [Payment Channels](https://github.com/bitpay/bivcore-channel)
- [Mnemonics](https://github.com/bitpay/bivcore/tree/master/packages/bivcore-mnemonic)
- [Elliptical Curve Integrated Encryption Scheme](https://github.com/bitpay/bivcore-ecies)
- [Blockchain Explorers](https://github.com/bitpay/bivcore-explorers)
- [Signed Messages](https://github.com/bitpay/bivcore-message)
