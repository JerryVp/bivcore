...
bivcore.versionGuard = function(version) {
  if (version !== undefined) {
    var message = 'More than one instance of bivcore-lib found. ' +
      'Please make sure to require bivcore-lib and check that submodules do' +
      ' not also include their own bivcore-lib dependency.';
...
// crypto
bivcore.crypto = {};
bivcore.crypto.BN = require('./lib/crypto/bn');
