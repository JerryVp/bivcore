...
We're working hard to make *bivcore* the most powerful JavaScript library for working with bitcoin. Our goal is to have *bivcore* be a library that can be used by anyone interested in bitcoin, and to level expertise differences with great design and documentation.

## Community

If there are any questions, etc., please feel to ask in one of the community channels:

- [Support Forum](https://labs.bitpay.com/c/bivcore)
- [Development Chat](https://gitter.im/bitpay/bivcore)
...
These are some global design goals in bivcore that any change must adhere.
...
When possible, bivcore objects should have standard methods on an instance prototype:
...
#### T3 - Require 'bivcore' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the bivcore object.

DO:

```javascript
var bivcore = require('../');
var PublicKey = bivcore.PublicKey;
```
...
```sh
git remote add bitpay git@github.com:bitpay/bivcore.git
...
Finally go to [github.com/bitpay/bivcore](https://github.com/bitpay/bivcore) in your web browser and issue a new pull request.

Main contributors will review your code and possibly ask for changes before your code is pulled in to the main repository.  We'll check that all tests pass, review the coding style, and check for general code correctness. If everything is OK, we'll merge your pull request and your code will be part of bivcore.

If you have any questions feel free to post them to
[github.com/bitpay/bivcore/issues](https://github.com/bitpay/bivcore/issues).
