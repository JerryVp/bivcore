...
var JSUtil = bivcore.util.js;
var Interpreter = bivcore.Script.Interpreter;

var sig_canonical = require('../data/bivcoind/sig_canonical');
var sig_noncanonical = require('../data/bivcoind/sig_noncanonical');
...
describe('Signature', function() {
  ...
  describe('@isTxDER', function() {
    ...
    describe('bivcoind fixtures', function() {
