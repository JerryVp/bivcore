...
var HDPrivateKey = bivcore.HDPrivateKey;
var HDPublicKey = bivcore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = bivcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(bivcore.crypto.BN.prototype, 'toBuffer').callsFake(function (args) {
      ...
      sandbox.spy(bivcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      bivcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = bivcore.PublicKey.fromPoint;
      bivcore.PublicKey.fromPoint = function() {
        bivcore.PublicKey.fromPoint = unstubbed;
