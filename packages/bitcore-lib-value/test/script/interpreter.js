...
var BufferWriter = bivcore.encoding.BufferWriter;
var Opcode = bivcore.Opcode;
var _ = require('lodash');

var script_tests = require('../data/bivcoind/script_tests');
var tx_valid = require('../data/bivcoind/tx_valid');
var tx_invalid = require('../data/bivcoind/tx_invalid');

//the script string format used in bitcoind data tests
Script.fromBivcoindString = function(str) {
...
describe('Interpreter', function() {
  ...
  var testFixture = function(vector, expected, witness, amount) {
    var amount = amount || 0;
    var scriptSig = Script.fromBivcoindString(vector[0]);
    var scriptPubkey = Script.fromBivcoindString(vector[1]);
  ...
  describe('bivcoind script evaluation fixtures', function() {
      ...
      set.forEach(function(vector) {
        ...
        it('should pass tx_' + (expected ? '' : 'in') + 'valid vector ' + cc, function() {
          ...
          inputs.forEach(function(input) {
            ...
            map[txid + ':' + txoutnum] = Script.fromBivcoindString(scriptPubKeyStr);
          });
