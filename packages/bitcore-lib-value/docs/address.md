# Bitcoin Value Address

// TO-DO
Represents a bitcoin value address. Addresses are the most popular way to make bitcoin value transactions. See [the official Bitcoin Wiki]() for technical background information.

## Instantiate an Address

To be able to receive bitcoin values an address is needed, but in order to spend them a private key is necessary. Please take a look at the [`PrivateKey`](privatekey.md) docs for more information about exporting and saving a key.
