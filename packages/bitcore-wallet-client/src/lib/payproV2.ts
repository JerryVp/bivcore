...
const Bitcore = require('@sotatek-anhdao/crypto-wallet-core').BitcoreLib;
const _ = require('lodash');
const sha256 = Bitcore.crypto.Hash.sha256;
const BN = Bitcore.crypto.BN;
var Bitcore_ = {
  btc: Bitcore,
  bch: require('@sotatek-anhdao/crypto-wallet-core').BitcoreLibCash,
  biv: require('@sotatek-anhdao/crypto-wallet-core').BitcoreLibValue,
};
var MAX_FEE_PER_KB = {
  btc: 10000 * 1000, // 10k sat/b
  bch: 10000 * 1000, // 10k sat/b
  biv: 10000 * 1000, // 10k sat/b
...
export class PayProV2 {
   ...
   * @param {string} paymentUrl - the payment protocol specific url
   * @param {string} chain - The cryptocurrency chain of the payment (BTC, BCH, BIV, ETH, etc)
