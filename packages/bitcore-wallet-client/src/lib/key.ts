...
import { BitcoreLib, BitcoreLibCash, BitcoreLibValue, Deriver, Transactions } from '@sotatek-anhdao/crypto-wallet-core';
...
export class Key {
  ...
  createCredentials = function (password, opts) {
    ...
    if (opts.network == 'testnet') {
      // Hacky: BTC/BCH/BIV xPriv depends on network: This code is to
