...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/@sotatek-anhdao/bitcore-build/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-value -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-value -o bitcore-lib-value.js';
    }
