...
var Hash = bivcore.crypto.Hash;
var Random = bivcore.crypto.Random;
 ...
 * See BIP39 specification for more info: https://github.com/bivcoin/bips/blob/master/bip-0039.mediawiki
...
var Mnemonic = function(data, wordlist) {
  ...
  if (Buffer.isBuffer(data)) {
    ...
    throw new bivcore.errors.InvalidArgument('data', 'Must be a Buffer, a string or an integer');
  }
  ent = ent || 128;
  ...
  if (ent % 32 !== 0 || ent < 128 || ent > 256) {
    throw new bivcore.errors.InvalidArgument('ENT', 'Values must be ENT > 128 and ENT < 256 and ENT % 32 == 0');
  }
 ...
 * Optionally receive a passphrase and bivcoin network.
 *
 * @param {String=} [passphrase]
...
Mnemonic.prototype.toHDPrivateKey = function(passphrase, network) {
  ...
  return bivcore.HDPrivateKey.fromSeed(seed, network);
};
