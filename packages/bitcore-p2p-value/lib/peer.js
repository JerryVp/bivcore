 ...
 * using the standard Bitcoin Value protocol. A Peer instance represents one connection
 * on the Bitcoin Value network. To create a new peer connection provide the host and port
