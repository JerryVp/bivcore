...
export type GetNetworkInfoParams = ChainNetwork;
...
export interface IChainStateService {
  ...
  getNetworkInfo(params: GetNetworkInfoParams): any;
  ...
  getFaucetHistory(params): Promise<any>;
  faucetCoin(params): Promise<any>;
