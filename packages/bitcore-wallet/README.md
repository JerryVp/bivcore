...
[![NPM Package](https://img.shields.io/npm/v/bivcore-wallet.svg?style=flat-square)](https://www.npmjs.org/package/bivcore-wallet)

**A simple Command Line Interface Wallet using [Bivcore Wallet Service](https://github.com/bitpay/bivcore/tree/master/packages/bivcore-wallet-service) and its *official* client lib [Bivcore Wallet Client](https://github.com/bitpay/bivcore/tree/master/packages/bivcore-wallet-client).**

This can be used to operate Bitcoin, Bitcoin Cash and Bitcoin Value wallets.
...
# git clone https://github.com/bitpay/bivcore/tree/master/packages/bivcore-wallet-service.git bws
